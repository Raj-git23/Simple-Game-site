...
export const all = [
    { link:a1, alt:"a1", type:"image"},
    { link:a2, alt:"a2", type:"image"},
    { link:v2, alt:"v2", type:"video"},
    { link:a3, alt:"a3", type:"image"},
    { link:a4, alt:"a4", type:"image"},
    { link:v3, alt:"v3", type:"video"},
    { link:a5, alt:"a5", type:"image"},
    { link:a6, alt:"a6", type:"image"},
    { link:a7, alt:"a7", type:"image"},
    { link:a8, alt:"a8", type:"image"},
    { link:v1, alt:"v1", type:"video"},
];
...
export const MerchandiseImage = [
    { frontimg:m2, bgimg:m1, alt:"m1"},
    { frontimg:m4, bgimg:m3, alt:"m2"},
    { frontimg:m6, bgimg:m5, alt:"m3"},
    { frontimg:m8, bgimg:m7, alt:"m4"},
];
